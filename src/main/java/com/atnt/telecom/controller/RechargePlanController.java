...
public class RechargePlanController {
	...
	public Long updateRechangePlan(@RequestBody RechargePlan rechargePlan) {
		LOG.info("updateRechangePlan begin..");
		return rechargePlanService.updatePlan(rechargePlan);
	}
}
